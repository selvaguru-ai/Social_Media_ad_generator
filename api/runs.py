...
# Cursor (and some corporate laptops) inject HTTP_PROXY. Meta and Apollo
# reject that tunnel with 403, which the pipeline then stores as "0 ads / 0
# leads". Child processes must talk to those APIs directly.
_PROXY_ENV_KEYS = (
    "HTTP_PROXY",
    "HTTPS_PROXY",
    "ALL_PROXY",
